locals {
  ...
  # see the CiliumL2AnnouncementPolicy type at https://github.com/cilium/cilium/blob/v1.17.4/pkg/k8s/apis/cilium.io/v2alpha1/l2announcement_types.go#L23-L42
  # see the CiliumLoadBalancerIPPool type at https://github.com/cilium/cilium/blob/v1.17.4/pkg/k8s/apis/cilium.io/v2alpha1/lbipam_types.go#L23-L47
...
// see https://github.com/cilium/cilium/tree/v1.17.4/install/kubernetes/cilium
...
data "helm_template" "cilium" {
  ...
  set {
    name  = "cgroup.autoMount.enabled" #1
    value = "false"
  }
  set {
    name  = "cgroup.hostRoot" #2
    value = "/sys/fs/cgroup"
  }
  set {
    name  = "k8sServiceHost"
